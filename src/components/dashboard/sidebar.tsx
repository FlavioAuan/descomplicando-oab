...
const adminLinks = [
  ...
  { href: '/admin/exercises', icon: Zap, label: 'Exercícios' },
  { href: '/admin/materials', icon: BookOpen, label: 'Conteúdo' },
  { href: '/admin/flashcards', icon: Brain, label: 'Flashcards' },
...
const superAdminLinks = [
  ...
  { href: '/admin/simulations', icon: ClipboardList, label: 'Simulados' },
  { href: '/admin/exercises', icon: Zap, label: 'Exercícios' },
  { href: '/admin/materials', icon: BookMarked, label: 'Conteúdo' },
  { href: '/admin/flashcards', icon: Brain, label: 'Flashcards' },
